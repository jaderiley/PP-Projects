...
const CONFIG = {
  ...
  business: {
    name:      "P.P Projects",
    phone:     "+27 71 471 5852",
    whatsapp:  "+27 71 471 5852",
    address:   "9 Cope St, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "P.P Projects — Pool services in johannesburg",
    description: "P.P Projects provides professional pool services in Johannesburg. 24 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "P.P Projects keeps swimming pools clean, chemically balanced and fully functional across Johannesburg. Maintenance, repairs, pump and filter work — we handle it all.",
    ...
    band: {
      ...
      alt:   "P.P Projects team at work in Johannesburg",
    ...
    // ─── REVIEWS ───────────────────────────────────────────
    reviewsTitle: "From 24 verified Google reviews.",
    reviews: [
      {
